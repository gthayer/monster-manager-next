...
export const MonstersContext = createContext({
	...
	filterMonsters() {
		...
		console.log( this.monsters.filter(monster => { return monster.size === this.filters.size; }));
		return this.monsters.filter(monster => { return monster.size === this.filters.size })
	}
});
